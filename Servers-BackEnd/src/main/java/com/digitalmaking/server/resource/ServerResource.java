package com.digitalmaking.server.resource;

import com.digitalmaking.server.model.Response;
import com.digitalmaking.server.model.Server;
import com.digitalmaking.server.service.implementation.ServerServiceImplementation;
...
public class ServerResource {
    ...
    public byte[] getServerImage(@PathVariable("fileName") String fileName) throws IOException {
        return Files.readAllBytes(Paths.get(System.getProperty("user.home") + "Images/Server/" + fileName));
    }
